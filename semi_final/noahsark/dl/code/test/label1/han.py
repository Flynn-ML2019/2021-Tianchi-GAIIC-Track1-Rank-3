...
class HierarchialAttentionNetwork(nn.Module):
    ...
    def __init__(self, embed_num):
        ...
        emb_size = HANConfig.emb_size
        word_rnn_size = HANConfig.word_rnn_size
        sentence_rnn_size = HANConfig.sentence_rnn_size
        word_rnn_layers = HANConfig.word_rnn_layers
        sentence_rnn_layers = HANConfig.sentence_rnn_layers
        word_att_size = HANConfig.word_att_size
        sentence_att_size = HANConfig.sentence_att_size
        dropout = HANConfig.dropout
    ...
    def forward(self, documents):
        ...
        """
        sentences_per_document = torch.LongTensor([documents.shape[1]] * documents.shape[0])
        words_per_sentence = torch.LongTensor([[documents.shape[2]] * documents.shape[1]] * documents.shape[0])
...
if __name__ == "__main__":
    net = HierarchialAttentionNetwork(embed_num=1000)
