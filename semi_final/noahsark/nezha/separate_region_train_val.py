...
def region_task_train():
    all_datas, all_labels = read_train_region()
    ...
    for train_index, valid_index in k_fold.split(X, Y):
        ...
        total_steps = int(run_config.separate_region_num_epochs * sample_count / run_config.batch_size)
        ...
        model.fit(
            ...
            epochs=run_config.separate_region_num_epochs,
        ...
        model.save_weights('%s/separate_region_fold_%s_weights.h5' % (directory.MODEL_DIR, fold))
